...
mein_toaster = toaster(2, "Rot") #Übergabe der Parameter (Anzahl der Schaechte und die Farbe des Toasters)
mein_toaster.zeit_einstellen(5) #Übergabe der Toastzeit
